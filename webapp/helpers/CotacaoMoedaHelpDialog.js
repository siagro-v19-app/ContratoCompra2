sap.ui.define([
	...
	return {
		...
		handleValueHelp: function(oView, sInputId, oController) {
			...
			var sFrag = "br.com.idxtecContratoCompra.helpers.CotacaoMoedaHelpDialog"; 
		...
		_handleValueHelpSearch : function (evt) {
			...
			var aFilters = [];
			var oFilter1 = new sap.ui.model.Filter( "Cotacao", sap.ui.model.FilterOperator.Contains, sValue);
